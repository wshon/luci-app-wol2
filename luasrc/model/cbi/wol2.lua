...
local t, e
t = Map("wol2", translate("wol2"), translate("Wake up your LAN device") .. [[<br /><br /><a href="https://github.com/wshon/openwrt-packages" target="_blank">Powered by wshon</a>]])
t.template = "wol2/index"
